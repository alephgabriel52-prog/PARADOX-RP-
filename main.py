...
@bot.command(name="anuncio",aliases=["anúncio"])
async def anuncio(ctx):await ctx.send("✅ V97 FUNCIONANDO COM ACENTO")

@bot.command(name="anuncios",aliases=["anúncios"])
async def anuncios(ctx):await ctx.send("✅ V97 FUNCIONANDO COM ACENTO")
