...
# CLASSES DO TICKET E WHITELIST IGUAIS DA V70 - COPIA DE CIMA
...
@bot.event
async def on_ready():
    await bot.tree.clear_commands(guild=None) # LIMPA COMANDOS ANTIGOS
    await bot.tree.sync()
    print(f'✅ V71 ONLINE - COMANDOS LIMPADOS')
